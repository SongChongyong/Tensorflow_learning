...
# 数据流图写入事件文件,分别保持在./mnist_histogram/image和./mnist_image/test文件夹下
train_writer = tf.summary.FileWriter('./mnist_image' + '/train', sess.graph)
test_writer = tf.summary.FileWriter('./mnist_image' + '/test')
...
# $tensorboard --logdir=./mnist_image 启动TensorBoard，而后进入浏览器查看生成的权重值的数据分布
